                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto nav-sub">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="./blog-grid.php"> Blog </a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="./about.php"> About </a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="contact-us.php"> contact us </a>
                                </li>
                            </ul>
                            <ul class="nav-icon-wrap">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="https://www.youtube.com/@DrShriramKulkarni18abk"><i class="fab fa-youtube"></i></a>
                                </li>
