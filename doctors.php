                            ...
                            <ul class="navbar-nav mr-auto nav-sub">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.php">Home Page One</a>
                                        <a class="dropdown-item" href="index-2.php">Home Page Two</a>
                                        <a class="dropdown-item" href="index-3.php">Home Page Three</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="services.php">Dental Care</a>
                                        <a class="dropdown-item" href="services-2.php">Cardiology</a>
                                        <a class="dropdown-item" href="services-3.php">Neurology </a>
                                        <a class="dropdown-item" href="services-detail.php">Eye Care</a>
                                    </div>
                                </li>
                                        <!-- Sub Menu -->
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu1">
                                                        <li><a class="dropdown-item" href="services.php">Services
                                                                One</a></li>
                                                        <li><a class="dropdown-item" href="services-2.php">Services
                                                                Two</a></li>
                                                        <li><a class="dropdown-item" href="services-3.php">Services
                                                                Three</a></li>
                                                                <li><a class="dropdown-item" href="services-detail.php">Service
                                                                    Detail</a></li>
                                                    </ul>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu1">
                                                        <li><a class="dropdown-item" href="doctors.php">Doctors One</a></li>
                                                        <li><a class="dropdown-item" href="doctors-2.php">Doctors Two</a></li>
                                                        <li><a class="dropdown-item" href="doctors-3.php">Doctors Three</a></li>
                                                    </ul>
                                                </li>
                                                <li class="nav-item">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="blog-standard.php">Blog Stadared</a>
                                                <a class="dropdown-item" href="blog-list.php">Blog List</a>
                                                <a class="dropdown-item" href="blog-grid.php">Blog Grid</a>
                                                <a class="dropdown-item" href="blog-grid-2.php">Blog Grid-2</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="contact-us.php">Contact One</a>
                                        <a class="dropdown-item" href="contact-us-2.php">Contact Two</a>
                                        <a class="dropdown-item" href="error.php">Error 404</a>
                                    </div>
                                </li>
                            </ul>
